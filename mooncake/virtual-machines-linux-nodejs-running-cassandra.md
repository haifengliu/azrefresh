...
#####1. Deprovision#####
Use the command ※sudo waagent 每deprovision+user§ to remove Virtual Machine instance specific information. See for [How to Capture a Linux Virtual Machine](http://azure.microsoft.com/zh-cn/documentation/articles/virtual-machines-linux-capture-image/) to Use as a Template more details on the image capture process. 
