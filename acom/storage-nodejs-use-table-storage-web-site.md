...
[Create and deploy a Node.js application to Azure Web Sites]: /zh-cn/documentation/articles/web-sites-nodejs-develop-deploy-mac/
[Publishing to Azure Web Sites with Git]: /zh-cn/documentation/articles/web-sites-publish-source-control/
...
[Create and deploy a Node.js application to an Azure Web Site]: /zh-cn/documentation/articles/web-sites-nodejs-develop-deploy-mac/
